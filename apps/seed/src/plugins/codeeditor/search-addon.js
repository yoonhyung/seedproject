...
define([
    ...
    (function() {
        ...
        function showDialog(cm, replace, callbacks) {
            ...
            // WTC-387
            searchDlg.bind('keyup', function(e) {
                e.stopPropagation();
            });
            ...
            var searchNavLeft = makeNavButton(searchDlgFirstLine, 'previous', {
                    margin: '0 186px 0 0'
                },
            ...
            var searchNavRight = makeNavButton(searchDlgFirstLine, 'next', {
                    margin: '0 156px 0 0'
                },
                ...
                if (state.query) {
                    ...
                    if (!cursor.find(rev)) {
                        cursor = cm.getSearchCursor(state.query, {
                            line: rev ? cm.lastLine() : cm.firstLine(),
                            ch: 0
                        });
                        if (!cursor.find(rev)) {
                            return;
        ...
        CodeMirror.commands.find = function(cm) {
            showFindReplaceDialog(cm, false);
        };
        CodeMirror.commands.replace = function(cm) {
            showFindReplaceDialog(cm, true);
        };
